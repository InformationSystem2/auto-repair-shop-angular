...
export class SwitchComponent implements ControlValueAccessor {
  ...
  thumbClasses = computed(() =>
    cn(
      'pointer-events-none block h-5 w-5 rounded-full bg-white shadow-md ring-0 transition-transform dark:bg-white',
